...
export class WorkflowService {
  ...
  operatorConfig: { [key: string]: string[] }  = {
      ...
      "terminate": [],
      // variable operator 
      "append_to_array": ["scope", "varibale", "value"],
      "append_to_string" : ["scope", "variable", "value"],
      "merge_array" : ["scope", "variable", "value", ],
      "decrement" : ["scope", "variable",],
      "increment" : ["scope", "variable"],
      "initializer" : ["scope", "variable", "value"],
      "set_var" : ["scope", "variable", "value"],
      "filter" : ["scope", "variable", "value", "condition"],
      "deduplicate" : ["scope", "variable", "value", "condition"],
      // system operator
      "wait": ["timePeriod"],     
      "run": ["run", "fallback", "provider", "requires"],
      "delete_file": ["source", "embedded"],
      "move_file":  ["source", "target", "embedded"],
  };
